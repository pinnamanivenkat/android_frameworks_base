...
public final class SmsManager {
        ...
        try {
            ...
            if (iccISms != null) {
                iccISms.sendTextForSubscriberWithOptions(getSubscriptionId(),
                        ...
                        sentIntent, deliveryIntent, persistMessage,  priority, isExpectMore,
                        validityPeriod);
            }
        } catch (RemoteException ex) {
            // ignore it
    ...
    public void sendTextMessageWithoutPersisting(
        ...
        sendTextMessageInternal(destinationAddress, scAddress, text, sentIntent, deliveryIntent,
                false /* persistMessage */, priority, isExpectMore, validityPeriod);
    }
    ...
    public void sendMultipartTextMessageWithoutPersisting(
            ...
            int priority, boolean isExpectMore, int validityPeriod) {
        sendMultipartTextMessageInternal(destinationAddress, scAddress, parts, sentIntents,
                deliveryIntents, false /* persistMessage*/, priority, isExpectMore,
                validityPeriod);
    }
